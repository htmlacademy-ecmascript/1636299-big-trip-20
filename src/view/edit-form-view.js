...
import {DATE_TIME_EDIT_EVENT} from '../const';
import {offersByTypes} from '../mock/point-trip';

const createFormEditTemplate = (point) => {
  const {basePrice, dateFrom, timeFrom, timeTo, dateTo, destination, description, type} = point;
